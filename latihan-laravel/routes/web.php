...
Route::get('/mahasiswa-data/{id}', [MahasiswaWebController::class, 'show'])->name('mahasiswa.showdata');

Route::get('/mahasiswa-top-ipk', [MahasiswaWebController::class, 'topIpkTeknikKomputer'])->name('mahasiswa.topipk');